...
public class OverwrittenKeyCheck extends IssuableSubscriptionVisitor {
  ...
  private static final MethodMatcher MAP_PUT = MethodMatcher.create().ofType(TypeCriteria.subtypeOf("java.util.Map")).names("put")
    .addParametersMatcher(TypeCriteria.anyType(), TypeCriteria.anyType());
