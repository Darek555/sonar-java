...
public class InputStreamReadCheck extends IssuableSubscriptionVisitor {
  ...
  private static final MethodMatcher INPUT_STREAM_READ = MethodMatcher.create().ofType(TypeCriteria.subtypeOf("java.io.InputStream")).names("read").addWithoutParametersMatcher();
